...
const Page = async () => {
  ...
  return (
    ...
    <div className='py-10'>
      <h1 className='text-7xl font-roundo font-semibold text-center line-clamp-3 max-w-4xl mx-auto'>Les articles pour les chauves par un chauve.</h1>
      <p className='text-center text-xl mt-4 max-w-3xl mx-auto'>Je vous partage mes avis sur les produits que j'ai testé, les différentes marques et mes tutoriels pour se raser comme un pro.</p>
    </div>
