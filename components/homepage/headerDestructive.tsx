  ...
  return (
    <section className="pt-20 bg-white">
      <div className="relative container">
        <h1 className="sm:text-7xl text-[#001744] md:text-6xl leading-tight font-medium mb-8 md:mb-4">
          Une petite famille, des expériences et{" "}
          <span className="text-[#6E788C]">
            des avis sincères, tout simplement !
          </span>
        </h1>
